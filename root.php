...
<body>
<!-- modify position -->
		<!-- UPDATE person SET position = 15 WHERE person.id = 5; -->
		...
		<!-- delete Person -->
		<!-- DELETE FROM person WHERE person.id = 7; -->
		<div style = "padding: 16px;">
			<h3>Delete User</h3>
			<?php
			...
			?>
			<form method="post">
				<input id="text" type="text" name="add_sell_id" placeholder="Enter the User ID"><br><br>
